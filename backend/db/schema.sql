...
CREATE TABLE IF NOT EXISTS applications (
  ...
  -- Status & lifecycle
  status            ENUM('draft','pending','under_review','approved','assigned','in_progress','completed','delivered','rejected','cancelled') NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS tool_requests (
  ...
  remarks         TEXT NULL,
  status          ENUM('pending','approved','dispatched','returned','rejected','cancelled') DEFAULT 'pending',
  admin_remark    TEXT NULL,
  processed_by    VARCHAR(36) NULL,
