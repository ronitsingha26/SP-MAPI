...
VALUES (
        UUID(),
        'mapi',
        'Land Measurement (Mapi)',
        'Measure property boundaries, dimensions, area',
        0.00,
        'sqft',
        3.00,
        TRUE
    ...
    (
        UUID(),
        'bantwara',
        'Land Partition (Bantwara)',
        'Legal division of jointly-held property among co-owners',
        0.00,
        'sqft',
        5.00,
        TRUE
    ...
    (
        ...
        'map',
        'Map Provision',
        'Generate/provide official land maps, digital mapping',
        0.00,
        'fixed',
        0.00,
        TRUE
    ...
    (
        ...
        'tools',
        'Amin Tools Request',
        'Request surveying tools and equipment',
        0.00,
        'fixed',
        0.00,
        TRUE
...
SELECT UUID(), 'Super Admin', 'superadmin@spmapi.in', '$2a$10$G.pwtjfRrMAK7qD5PA0nf.v0F9Synhc0T00q0fiGb9.XEXvG9Zkhq', '9999999999'
FROM DUAL
WHERE
    NOT EXISTS (
        SELECT 1
